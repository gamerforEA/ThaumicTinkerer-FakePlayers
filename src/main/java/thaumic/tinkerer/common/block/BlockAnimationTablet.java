...
public class BlockAnimationTablet extends BlockModContainer
{
	...
	{
		this.iconBottom = IconHelper.forBlock(par1IconRegister, this, 0);
		this.iconTop = IconHelper.forBlock(par1IconRegister, this, 1);
		this.iconSides = IconHelper.forBlock(par1IconRegister, this, 2);
	}
	...
	{
		return new ThaumicTinkererArcaneRecipe(LibResearch.KEY_ANIMATION_TABLET, LibResearch.KEY_ANIMATION_TABLET, new ItemStack(ThaumicTinkerer.registry.getFirstBlockFromClass(BlockAnimationTablet.class)), new AspectList().add(Aspect.AIR, 25).add(Aspect.ORDER, 15).add(Aspect.FIRE, 10), "GIG", "ICI", 'G', new ItemStack(Items.gold_ingot), 'I', new ItemStack(Items.iron_ingot), 'C', new ItemStack(ConfigItems.itemGolemCore, 1, 100));
