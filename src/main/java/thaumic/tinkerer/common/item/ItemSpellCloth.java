...
public class ItemSpellCloth extends ItemBase
{
	...
	{
		this.setMaxDamage(LibFeatures.SPELL_CLOTH_USES);
	...
	public IRegisterableResearch getResearchItem()
	{
		...
		IRegisterableResearch research = (TTResearchItem) new TTResearchItem(LibResearch.KEY_SPELL_CLOTH, new AspectList().add(Aspect.MAGIC, 2).add(Aspect.CLOTH, 1), 3, 2, 2, new ItemStack(this)).setParentsHidden("ENCHFABRIC").setPages(new ResearchPage("0"), ResearchHelper.crucibleRecipePage(LibResearch.KEY_SPELL_CLOTH));
		return research;
	...
	{
		// TODO gamerforEA code replace, old code: return stack;
		if (stack != null)
		{
