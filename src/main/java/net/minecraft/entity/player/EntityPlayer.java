...
public abstract class EntityPlayer extends EntityLivingBase implements ICommandSender
{
	...
	public EntityPlayer(World p_i45324_1_, GameProfile p_i45324_2_)
	{
		...
		this.setLocationAndAngles(chunkcoordinates.posX + 0.5D, chunkcoordinates.posY + 1, chunkcoordinates.posZ + 0.5D, 0.0F, 0.0F);
	...
	public EntityItem func_146097_a(ItemStack p_146097_1_, boolean p_146097_2_, boolean p_146097_3_)
	{
		...
		{
			EntityItem entityitem = new EntityItem(this.worldObj, this.posX, this.posY - 0.30000001192092896D + this.getEyeHeight(), this.posZ, p_146097_1_);
	...
	public float getBreakSpeed(Block p_146096_1_, boolean p_146096_2_, int meta, int x, int y, int z)
	{
		...
		if (this.isPotionActive(Potion.digSlowdown))
			f *= 1.0F - (this.getActivePotionEffect(Potion.digSlowdown).getAmplifier() + 1) * 0.2F;
	...
	protected void damageEntity(DamageSource p_70665_1_, float p_70665_2_)
	{
		if (!this.isEntityInvulnerable())
		{
			...
			p_70665_2_ = ArmorProperties.ApplyArmor(this, this.inventory.armorInventory, p_70665_1_, p_70665_2_);
			if (p_70665_2_ <= 0)
				return;
			...
			if (!p_71059_1_.hitByEntity(this))
			{
				...
				if (f > 0.0F || f1 > 0.0F)
				{
					...
					if (flag2)
					{
						if (i > 0)
						{
							p_71059_1_.addVelocity(-MathHelper.sin(this.rotationYaw * (float) Math.PI / 180.0F) * i * 0.5F, 0.1D, MathHelper.cos(this.rotationYaw * (float) Math.PI / 180.0F) * i * 0.5F);
							this.motionX *= 0.6D;
							this.motionZ *= 0.6D;
	...
	public EntityPlayer.EnumStatus sleepInBedAt(int p_71018_1_, int p_71018_2_, int p_71018_3_)
	{
		...
		if (this.worldObj.blockExists(p_71018_1_, p_71018_2_, p_71018_3_))
		{
			...
			this.func_71013_b(l);
			this.setPosition(p_71018_1_ + f1, p_71018_2_ + 0.9375F, p_71018_3_ + f);
		}
		else
	...
	public void wakeUpPlayer(boolean p_70999_1_, boolean p_70999_2_, boolean p_70999_3_)
	{
		...
		if (chunkcoordinates != null && block.isBed(this.worldObj, chunkcoordinates.posX, chunkcoordinates.posY, chunkcoordinates.posZ, this))
		{
			...
			this.setPosition(chunkcoordinates1.posX + 0.5F, chunkcoordinates1.posY + this.yOffset + 0.1F, chunkcoordinates1.posZ + 0.5F);
		}
		...
		if (this.ridingEntity == null)
		{
			...
			else if (this.onGround)
			{
				...
				if (i > 0)
				{
					...
					if (this.isSprinting())
						this.addExhaustion(0.099999994F * i * 0.01F);
					else
	...
	protected void fall(float p_70069_1_)
	{
		...
		{
			if (p_70069_1_ >= 2.0F)
				this.addStat(StatList.distanceFallenStat, (int) Math.round(p_70069_1_ * 100.0D));
	...
	public Vec3 getPosition(float par1)
	{
		...
		else
		{
			...
			double d1 = this.prevPosY + (this.posY - this.prevPosY) * par1 + (this.getEyeHeight() - this.getDefaultEyeHeight());
